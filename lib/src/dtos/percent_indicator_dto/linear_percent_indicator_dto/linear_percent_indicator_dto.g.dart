...
LinearPercentIndicatorDTO _$LinearPercentIndicatorDTOFromJson(
    Map<String, dynamic> json) {
  return LinearPercentIndicatorDTO(
    percent: (json['percent'] is String)
        ? (double.parse(json['percent'])).toDouble()
        : (json['percent'] as num?)?.toDouble() ?? 0.0,
    lineHeight: (json['lineHeight'] as num?)?.toDouble() ?? 8.0,
    fillColor:
        WidgetUtil.getColor(json['fillColor'] as String?) ?? Colors.transparent,
    ...
    linearGradientBackgroundColor: WidgetUtil.getLinearGradient(
        json['linearGradientBackgroundColor'] as String?),
    ...
    trailing: json['trailing'] == null
        ? null
        : DynamicWidget.fromJson(json['trailing'] as Map<String, dynamic>),
    ...
    alignment: WidgetUtil.getMainAxisAlignment(json['alignment'] as String?) ??
        MainAxisAlignment.start,
    widgetIndicator: json['widgetIndicator'] == null
        ? null
        : DynamicWidget.fromJson(
            json['widgetIndicator'] as Map<String, dynamic>),
  );
}
