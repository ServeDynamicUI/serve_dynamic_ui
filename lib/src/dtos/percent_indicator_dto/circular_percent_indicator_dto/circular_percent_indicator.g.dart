...
CircularPercentIndicatorDTO _$CircularPercentIndicatorDTOFromJson(
    ...
    CircularPercentIndicatorDTO(
      ...
      fillColor: WidgetUtil.getColor(json['fillColor'] as String?) ??
          Colors.transparent,
      backgroundColor:
          WidgetUtil.getColor(json['backgroundColor'] as String?) ??
      ...
      circularStrokeCap: WidgetUtil.getCircularStrokeCap(
              json['circularStrokeCap'] as String?) ??
          CircularStrokeCap.butt,
      arcBackgroundColor:
          WidgetUtil.getColor(json['arcBackgroundColor'] as String?),
