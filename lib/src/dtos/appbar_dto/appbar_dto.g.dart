...
AppBarDto _$AppBarDtoFromJson(Map<String, dynamic> json) {
  return AppBarDto(
    ...
    automaticallyImplyLeading: json['automaticallyImplyLeading'] as bool? ?? true,
    title: json['title'] == null ? null : DynamicWidget.fromJson(json['title'] as Map<String, dynamic>),
    ...
    leftActions: json['leftActions'] == null
        ...
        ?.map((e) => DynamicWidget.fromJson(e as Map<String, dynamic>))
        .toList(),
    flexibleSpace: json['flexibleSpace'] == null ? null : DynamicWidget.fromJson(json['flexibleSpace'] as Map<String, dynamic>),
    bottom: json['bottom'] == null ? null : DynamicWidget.fromJson(json['bottom'] as Map<String, dynamic>),
    ...
    toolbarTextStyle: json['toolbarTextStyle'] == null ? null : TextStyleDTO.fromJson(json['toolbarTextStyle'] as Map<String, dynamic>),
    titleTextStyle: json['titleTextStyle'] == null ? null : TextStyleDTO.fromJson(json['titleTextStyle'] as Map<String, dynamic>),
    forceMaterialTransparency: json['forceMaterialTransparency'] as bool? ?? false,
    clipBehavior: json['clipBehavior'] == null ? null : WidgetUtil.getClipBehavior(json['clipBehavior'] as String?),
    appBarGradient: WidgetUtil.getLinearGradient(json['appBarGradient'] as String?),
  );
}
